...
function websdkready() {
  ...
  var API_KEY = "6MU8VBFxRlmZcc2NjEV0ig";
   ...
   */
  var API_SECRET = "SbgxaJ9P3O48Y2IOc8pGuFcgoX6lj1genb9Q";
  ...
  document.getElementById("clear_all").addEventListener("click", function (e) {
    ...
    window.location.href = "http://127.0.0.1:8000/patients/video_call";
  });
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "http://127.0.0.1:8000/patients/meeting? " + testTool.serialize(meetingConfig);
          console.log(joinUrl);
  ...
  window.copyJoinLink = function (element) {
    ...
    var signature = ZoomMtg.generateSignature({
      ...
      success: function (res) {
        ...
        meetingConfig.apiKey = API_KEY;
        var joinUrl =
          testTool.getCurrentDomain() + "http://127.0.0.1:8000/patients/meeting? " + testTool.serialize(meetingConfig) ;
